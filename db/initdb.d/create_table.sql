...
(
    dead_letter_id varchar
(
    255
) not null,
    cause_message varchar
(
    255
),
    cause_type varchar
...
(
    ...
    token longblob, token_type varchar
(
    255
),
    type varchar
